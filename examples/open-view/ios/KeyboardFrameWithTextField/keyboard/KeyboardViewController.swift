...
class KeyboardViewController: FKKeyboardViewController {
    ...
    override func createConfiguration() -> KeyboardConfiguration {
        ...
        let config = KeyboardConfiguration( style: style,
                                           specialKeys: nil,
                                            apps: AppsConfiguration(keyboardApps: [KeyboardFrameViewCustom.init()], showAppsInCarousel: false), /// This is a new parameter. We share the View that might be invoked.
